...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MemberPresenter")))
@interface SharedMemberPresenter : SharedCoroutinePresenter
